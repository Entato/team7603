...
public class SpinManualRightCommand extends CommandBase {
  private final Spinner spinner;
  private final Joystick controller;

  // commands must take in a parameter of the subsystems they are using so they
  // can access their methods
  public SpinManualRightCommand(Spinner spinner, Joystick controller) {
  ...
  public void execute() {
    ...
    spinner.spinManualRight(controller.getRawAxis(Constants.RTrigger));
  }
